...
sim = s4l.document.AllSimulations['Real_Diffusion-Dirichlet']
if sim.HasResults():
...
sim = s4l.document.AllSimulations['Imag_Diffusion-Dirichlet']
if sim.HasResults():
	simulation_extractor = sim.Results()
	sensor_extractor = simulation_extractor["Overall Field"]
...
V_source_viz = hz.visualizeArray(v_field_3d, v_x, v_y, v_z, unit_name="Potential field",unit="V",name="Acoustoelectric Voltage Field-Dirichlet" )

E_source_viz = hz.visualizeArray(E_mag,v_x, v_y, v_z,unit_name="E field",unit="V/m",name="Acoustoelectric E field Dirichlet" )
